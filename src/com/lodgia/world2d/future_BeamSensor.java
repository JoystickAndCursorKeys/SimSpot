...
//
//
//check http://stackoverflow.com/questions/2115976/geometry-library-for-java
//
//
...
public class future_BeamSensor extends GenericSensor {

	public future_BeamSensor() {
		// pass
	}
	...
	public void sense(World2d w2d, PhysicalObject host) {
		...
		while (t < Objects.size()) {
			...
			if (o != host) {
				...
				*/
				if (o.shapetype==PhysicalObject.POLYGON)
				{
